  ...
  return (
    <div className="bg-[#0c101b] border border-[#1e293b] rounded-lg p-5 shadow-sm space-y-5">
      ...
      <div>
        ...
        <h3 className="text-xs font-bold text-white mt-0.5">eBPF Socket Interception & Metrics Pipeline</h3>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-4 items-stretch max-w-4xl mx-auto text-center font-mono text-[10px]">
        ...
        {/* Step 1 */}
        <div className="p-4 bg-[#080b11]/60 border border-[#1e293b] rounded-lg flex flex-col justify-between hover:border-[#334155] transition-all">
          <Cpu className="w-5 h-5 text-blue-500 mx-auto mb-2" />
          <div>
            <p className="font-bold text-white uppercase text-[9px] tracking-wider mb-1">1. User App</p>
        ...
        <div className="p-4 bg-[#080b11]/60 border border-[#1e293b] rounded-lg flex flex-col justify-between hover:border-[#334155] transition-all">
          ...
          <div>
            <p className="font-bold text-white uppercase text-[9px] tracking-wider mb-1">2. eBPF Filter</p>
        ...
        {/* Step 3 */}
        <div className="p-4 bg-[#080b11]/60 border border-[#1e293b] rounded-lg flex flex-col justify-between border-blue-500/30 shadow-[0_0_15px_rgba(59,130,246,0.05)] hover:border-[#334155] transition-all">
          ...
          <div>
            ...
            <p className="text-[9px] text-slate-400 leading-relaxed font-sans">Sidecar matches 16-bit transaction queries & response timestamps.</p>
          </div>
        </div>
        ...
        <div className="p-4 bg-[#080b11]/60 border border-[#1e293b] rounded-lg flex flex-col justify-between hover:border-[#334155] transition-all">
          ...
          <div>
            <p className="font-bold text-white uppercase text-[9px] tracking-wider mb-1">4. Prometheus</p>
        ...
        <div className="p-4 bg-[#080b11]/60 border border-[#1e293b] rounded-lg flex flex-col justify-between hover:border-[#334155] transition-all">
          ...
          <div>
            <p className="font-bold text-white uppercase text-[9px] tracking-wider mb-1">5. Operator UI</p>
